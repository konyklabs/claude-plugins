...
- /governor:decompose when the work touches more than about five files
- /governor:delegate per slice; workers: governor:implementer (or py-testing:test-implementer for tests); governor:reviewer on every slice that changes behaviour
